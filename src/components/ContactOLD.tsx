        ...
        <div className="grid md:grid-cols-2 gap-16">
          <div className={`space-y-10 ${isVisible ? "animate-fade-in-up opacity-0 delay-200" : "opacity-0"}`}>
            ...
            >
              ...
              <div className="w-full h-[250px] md:h-[300px] rounded-xl overflow-hidden border border-dark-border/50 shadow-inner group mt-6">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2880.149677501246!2d11.2518246!3d43.7905071!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x132a5778923a3c0d%3A0xc5e6e9518d1ea3e0!2sShock%20Bar!5e0!3m2!1sit!2sit!4v1776769058706!5m2!1sit!2sit" width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  loading="lazy"
                  ...
                  className="grayscale opacity-60 contrast-[1.1] transition-all duration-500 group-hover:opacity-100 group-hover:grayscale-0"
                />
              </div>
            </a>
            <div>
